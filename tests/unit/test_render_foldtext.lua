...
-- Unit tests for render/foldtext.lua — the query-derived summary string builder.
--
...
-- The string is rendered as a virt_lines_above extmark on the opening fence by
-- render/draw.set_summary (see tests/integration/test_folding.lua).
